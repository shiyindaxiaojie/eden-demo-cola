...
import org.ylzl.eden.demo.client.role.dto.command.RoleAssignPermissionsCmd;
...
@Slf4j
@Component
public class RoleAssignPermissionsCmdExe {
	...
	public Response execute(RoleAssignPermissionsCmd cmd) {
		...
		roleGateway.saveRolePermissions(cmd.getRoleId(),
			cmd.getPermissionIds() != null ? cmd.getPermissionIds() : Collections.emptyList());
